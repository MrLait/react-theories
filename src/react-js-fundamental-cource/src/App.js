...
//useEffect(callback, deps) - предназначен для жизненного цикла компонента. Работает примерно так же как и useMemo. Можно на первую отрисовку
// компонента получать данные с сервера
